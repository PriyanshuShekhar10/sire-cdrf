      ...
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.details}>
            ...
            founders consistently outperform those led by non-PhDs. These
            founders are distinguished by their specific field expertise,
            exceptional focus, and a natural propensity for innovation—traits
            imperative for success in deep-tech ventures. Recognizing a gap in
            business acumen, BITS Pilani introduced the PhD DRIVE (Deep-tech
            Research Innovation Value generation & Entrepreneurship) program in
            2024. This initiative is designed to bridge research with
            entrepreneurial acumen, fostering ventures that are rooted in
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>
              Cultivate cross-disciplinary ventures to tackle significant
              societal challenges.
            </li>
            <li>
              Graduate PhD students with advanced Technology Readiness Levels
              (TRL &gt; 5).
            </li>
            <li>
            ...
            <li>
              Assert BITS Pilani's dominance in key domains both domestically
              and internationally.
            </li>
            <li>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.details}>
            ...
            industry and alumni funds, along with streamlined entry to
            government funding schemes via TBIs.
          </p>
        </div>
      </div>
