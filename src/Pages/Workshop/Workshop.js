      ...
      <div className="workshop-content">
        <section className="about">
          ...
          <p>
            ...
            systems. The workshop brings together industry leaders and academic
            experts to discuss trends, innovations, and hands-on applications in
            this evolving field.
          </p>
          <p>
        ...
        <section className="highlights">
          ...
          <div className="highlight-grid">
            <div className="highlight-card">
              ...
              <p>
                Gain insights from renowned experts in battery technology and EV
                systems.
              </p>
            </div>
            <div className="highlight-card">
              ...
              <p>
                Participate in discussions on essential employability skills for
                the industry.
              </p>
            </div>
            <div className="highlight-card">
              ...
              <p>
                Experience live sessions on battery testing, understanding their
